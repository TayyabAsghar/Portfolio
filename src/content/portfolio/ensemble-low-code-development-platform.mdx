...
## Project Overview
At **Ensemble**, as a Software Developer, I contributed to the development of a **desktop application** for their web-based 
studio, extending the platform’s accessibility beyond browsers. My role involved **building the desktop application using 
Electron**, ensuring a seamless and responsive experience for users across different operating systems.

A key focus of the project was **optimizing API communication** by transitioning API calls from the front end to structured 
**API endpoints in Node.js**. This approach improved performance, scalability, and maintainability while enhancing the overall 
