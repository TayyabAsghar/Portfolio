...
integrate Gemini for answering user queries.
...
Responsive pricing page to showcase clear prices and features of the application. There are 2 action buttons for navigating back to the Dashboard and 
...
A simple Dashboard to showcase all the uploaded documents and chats along with the option to **Upload** a new Document, **Download** an Uploaded 
...
Click the **Add a Document** button that will open a Modal. Click to select a PDF document or Drag and Drop one. The modal will show an interactive 
...
Ask questions, summarize, or retrieve key insights from the document. You can also tell AI to answer the question as markdown. Along with that, you 
can **navigate** PDF pages, rotate the PDF, and zoom in/out of the PDF.
...
Upgraded members can cancel or renew subscriptions from the Stripe Portal.
