...
onboarding experience. It uses **Clerk Webhooks** with **Svix** to sync data with the **MongoDB** database.
...
enhanced control over content sharing and privacy settings. Users can edit their details whenever they want. The same page is opened when 
a user logs in for the first time as the **Onboarding Page** to get user details.
...
feed, helping build a personalized experience tailored to the user’s interests. If a user has set their profile to private, their  
...
Building **YASAC** was an invaluable experience that strengthened my skills as a **full-stack developer**. This project allowed 
